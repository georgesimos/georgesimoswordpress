...
class Recent_Posts_Extra_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'recent_posts_extra_widget', 'description' => __( "The most recent posts on your site, including post thumbnails & dates.", 'georgesimos'));
		parent::__construct('recent-posts-extra', __('Recent Posts Extra','georgesimos'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts Extra','georgesimos') : $instance['title']);
...
<?php
	...
	function form( $instance ) {
		...
		if ( !isset($instance['number']) || !$number = (int) $instance['number'] )
			...
			$number = 15;
?>
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'georgesimos'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of posts to show:', 'georgesimos'); ?></label>
		...
		<small><?php _e('(at most 15)', 'georgesimos'); ?></small></p>
<?php
	}
}
